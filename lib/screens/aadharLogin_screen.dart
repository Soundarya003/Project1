...
class AadharLogin extends StatefulWidget {
  ...
  @override
  State<AadharLogin> createState() => _AadharLoginState();
}

enum DocumentNeeded { PAN, VoterID }

class _AadharLoginState extends State<AadharLogin> {
    ...
    showDialog(
        ...
        builder: (BuildContext context){
          return AlertDialog(
            ...
            title: Text('Would you like to add a co-applicant?'),
            actions: <Widget>[
               Row(
            ...
            child: TextButton(
              onPressed: () => showDialog<String>(
                ...
                builder: (BuildContext context) => AlertDialog(
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.0)),
                  title: const Text('Applicant aadhaar verified successfully', style: TextStyle(fontSize: 15),),
                  actions: <Widget>[
                    Align(
